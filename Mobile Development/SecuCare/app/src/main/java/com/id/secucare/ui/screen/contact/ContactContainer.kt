...
fun ContactContainer(
    ...
    moveToAddEmergency: () -> Unit = {}
) {
    var state by remember { mutableStateOf(0) }
    val titles = listOf("General", "Personal")
    ...
    Column(modifier = modifier.padding(20.dp)) {
        Row(
            ...
            Icon(imageVector = Icons.Default.Search, contentDescription = null, modifier = Modifier.padding(end = 14.dp))
...
@Composable
@Preview
fun ShowContactContainerPreview() {
    SecuCareTheme {
        ContactContainer()
    }
}